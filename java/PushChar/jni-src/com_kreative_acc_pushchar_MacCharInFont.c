#include "com_kreative_acc_pushchar_MacCharInFont.h"
#include <CoreFoundation/CoreFoundation.h>
#include <ApplicationServices/ApplicationServices.h>
#include <string.h>
#include <stdio.h>

JNIEXPORT jboolean JNICALL Java_com_kreative_acc_pushchar_MacCharInFont_inFont__Ljava_lang_String_2I(JNIEnv * env, jclass cl, jstring fontName, jint charToCheck) {
...
JNIEXPORT jbooleanArray JNICALL Java_com_kreative_acc_pushchar_MacCharInFont_inFont__Ljava_lang_String_2II(JNIEnv * env, jclass cl, jstring fontName, jint startChar, jint endChar) {
	const char * ntvFontName = (*env)->GetStringUTFChars(env, fontName, 0);
...
JNIEXPORT jbooleanArray JNICALL Java_com_kreative_acc_pushchar_MacCharInFont_inFont__Ljava_lang_String_2_3I(JNIEnv * env, jclass cl, jstring fontName, jintArray charsToCheck) {
	const char * ntvFontName = (*env)->GetStringUTFChars(env, fontName, 0);
